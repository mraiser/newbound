...
let allowed: &[&str] = match mode.as_str() {
    "read" => &["status","log","diff","show","rev-parse","rev-list","branch","ls-files","blame","describe","remote","check-ignore"],
    "write" => &["add","commit","checkout","branch","merge","tag","stash","reset","revert","sparse-checkout","clean","rm"],

...
impl app_app {
  pub fn apps(&self) -> DataArray {
    ...
    RustCmd::new("ynjjnl182f0c30c2ej26bb").execute(d).unwrap().get_array("a")
  }
  pub fn asset(&self, nn_path:String) -> String {
    let mut d = DataObject::new();
    d.put_string("nn_path", &nn_path);
    RustCmd::new("hxusrn182ebab0fc8o1102").execute(d).unwrap().get_string("a")
  }
  pub fn assets(&self, lib:String) -> DataArray {
    let mut d = DataObject::new();
    d.put_string("lib", &lib);
    RustCmd::new("uirppm183059f5a37z1b0c").execute(d).unwrap().get_array("a")
  }
  pub fn delete(&self, lib:String, id:String, nn_sessionid:String) -> String {
    ...
    RustCmd::new("mhnrjq18347bcd5f7t27").execute(d).unwrap().get_string("a")
  }
  pub fn deletelib(&self, lib:String) -> String {
    let mut d = DataObject::new();
    d.put_string("lib", &lib);
    RustCmd::new("hkgorn1834268eb07k1406").execute(d).unwrap().get_string("a")
  }
  pub fn deviceid(&self) -> String {
    let mut d = DataObject::new();
    RustCmd::new("jypyqw1836795f8fbn2").execute(d).unwrap().get_string("a")
  }
  pub fn eventoff(&self, id:String) -> String {
    let mut d = DataObject::new();
    d.put_string("id", &id);
    RustCmd::new("xrysgt18350cb35cet3").execute(d).unwrap().get_string("a")
  }
  pub fn eventon(&self, id:String, app:String, event:String, cmdlib:String, cmdid:String) -> String {
    ...
    RustCmd::new("wlnoru18350ecc36cr4").execute(d).unwrap().get_string("a")
  }
  pub fn events(&self, app:String) -> DataArray {
    let mut d = DataObject::new();
    d.put_string("app", &app);
    RustCmd::new("spumvi1834c2cf1e6t2").execute(d).unwrap().get_array("a")
  }
  pub fn exec(&self, lib:String, id:String, args:DataObject, nn_sessionid:String) -> DataObject {
    ...
    d.put_string("nn_sessionid", &nn_sessionid);
    RustCmd::new("thoxjp182ee8eaebdt225").execute(d).unwrap().get_object("a")
  }
  pub fn jsapi(&self, nn_path:String) -> DataObject {
    let mut d = DataObject::new();
    d.put_string("nn_path", &nn_path);
    RustCmd::new("zmzwjn182ee9c7f0ar314").execute(d).unwrap().get_object("a")
  }
  pub fn libs(&self) -> DataArray {
    let mut d = DataObject::new();
    RustCmd::new("vtnluk1834262fb3fl137e").execute(d).unwrap().get_array("a")
  }
  pub fn login(&self, user:String, pass:String, nn_sessionid:String) -> String {
    ...
    d.put_string("nn_sessionid", &nn_sessionid);
    RustCmd::new("ztizvj182ee99186cp2d2").execute(d).unwrap().get_string("a")
  }
  pub fn newlib(&self, lib:String, readers:DataArray, writers:DataArray) -> String {
    ...
    RustCmd::new("stskpj183421d8115xd3f").execute(d).unwrap().get_string("a")
  }
  pub fn read(&self, lib:String, id:String, nn_sessionid:String) -> DataObject {
    ...
    d.put_string("id", &id);
    d.put_string("nn_sessionid", &nn_sessionid);
    RustCmd::new("nyzimq182eabf7339p7c5").execute(d).unwrap().get_object("a")
  }
  pub fn remembersession(&self, nn_session:DataObject) -> String {
    let mut d = DataObject::new();
    d.put_object("nn_session", nn_session);
    RustCmd::new("tsmxsj182ee9ac271o2f3").execute(d).unwrap().get_string("a")
  }
  pub fn settings(&self, settings:Data) -> DataObject {
    let mut d = DataObject::new();
    d.set_property("settings", settings);
    RustCmd::new("knhvsn182f9997b1dxd04").execute(d).unwrap().get_object("a")
  }
  pub fn timeroff(&self, id:String) -> String {
    let mut d = DataObject::new();
    d.put_string("id", &id);
    RustCmd::new("hompli1835678a4efz2").execute(d).unwrap().get_string("a")
  }
  pub fn timeron(&self, id:String, data:DataObject) -> String {
    let mut d = DataObject::new();
    d.put_string("id", &id);
    d.put_object("data", data);
    RustCmd::new("spjvvp183568021f1o2").execute(d).unwrap().get_string("a")
  }
  pub fn uninstall(&self, app:String) -> String {
    let mut d = DataObject::new();
    d.put_string("app", &app);
    RustCmd::new("gttrqg18303bc96c9w898").execute(d).unwrap().get_string("a")
  }
  pub fn unique_session_id(&self) -> String {
    let mut d = DataObject::new();
    RustCmd::new("ynpmir183479da2b9r25f8").execute(d).unwrap().get_string("a")
  }
...
impl app_service {
  pub fn init(&self) -> String {
    let mut d = DataObject::new();
    RustCmd::new("mjkrmm183e1fdb2d2r8").execute(d).unwrap().get_string("a")
  }
}
impl app_util {
  pub fn hash(&self, file:String) -> String {
    ...
    RustCmd::new("kgkxpw183664f5554q4").execute(d).unwrap().get_string("a")
  }
  pub fn init(&self) -> String {
    let mut d = DataObject::new();
    RustCmd::new("thtpku18366290644p4").execute(d).unwrap().get_string("a")
  }
  pub fn zip(&self, srcdir:String, destfile:String) -> bool {
    let mut d = DataObject::new();
    d.put_string("srcdir", &srcdir);
    d.put_string("destfile", &destfile);
    RustCmd::new("guuqrj1836147b650zd").execute(d).unwrap().get_boolean("a")
  }
}
impl security_security {
  pub fn current_user(&self, nn_session:DataObject) -> DataObject {
    let mut d = DataObject::new();
    d.put_object("nn_session", nn_session);
    RustCmd::new("ihxsxh18410251dfapf7").execute(d).unwrap().get_object("a")
  }
  pub fn deleteuser(&self, id:String) -> String {
    let mut d = DataObject::new();
    d.put_string("id", &id);
    RustCmd::new("jszjgy1836bfe023ckc").execute(d).unwrap().get_string("a")
  }
  pub fn groups(&self) -> DataArray {
    let mut d = DataObject::new();
    RustCmd::new("qjmvtm1836b1bc850o9").execute(d).unwrap().get_array("a")
  }
  pub fn init(&self) -> DataObject {
    let mut d = DataObject::new();
    RustCmd::new("suvlkp1846cfa2235q2c").execute(d).unwrap().get_object("a")
  }
  pub fn setuser(&self, id:String, displayname:String, password:String, groups:DataArray, keepalive:Data, address:Data, port:Data) -> DataObject {
    ...
    RustCmd::new("soqxoo1836bb51d5dy2").execute(d).unwrap().get_object("a")
  }
  pub fn users(&self) -> DataObject {
    let mut d = DataObject::new();
    RustCmd::new("ysnihn1836b0814aen5").execute(d).unwrap().get_object("a")
  }
}
impl dev_dev {
  pub fn check(&self, lib:String, ctl:String, cmd:String) -> String {
    ...
    d.put_string("ctl", &ctl);
    d.put_string("cmd", &cmd);
    RustCmd::new("gsxkwg184e3fc96f9s2e1").execute(d).unwrap().get_string("a")
  }
  pub fn compile(&self, lib:String, ctl:String, cmd:String) -> String {
    ...
    d.put_string("ctl", &ctl);
    d.put_string("cmd", &cmd);
    RustCmd::new("gjssly1834862d5acg37d9").execute(d).unwrap().get_string("a")
  }
  pub fn compile_rust(&self) -> String {
    let mut d = DataObject::new();
    RustCmd::new("mhxogz1858786d9e1scf").execute(d).unwrap().get_string("a")
  }
  pub fn install_lib(&self, uuid:String, lib:String) -> bool {
    let mut d = DataObject::new();
    d.put_string("uuid", &uuid);
    d.put_string("lib", &lib);
    RustCmd::new("kqgjmx1840a9081cdh172").execute(d).unwrap().get_boolean("a")
  }
  pub fn lib_archive(&self, lib:String, version:i64) -> String {
    let mut d = DataObject::new();
    d.put_string("lib", &lib);
    d.put_int("version", version);
    RustCmd::new("uykmrm183dbd15cdeu7b").execute(d).unwrap().get_string("a")
  }
  pub fn lib_info(&self, lib:String) -> DataObject {
    let mut d = DataObject::new();
    d.put_string("lib", &lib);
    RustCmd::new("knwozu1840a764abcu135").execute(d).unwrap().get_object("a")
  }
  pub fn rebuild_lib(&self, lib:String) -> String {
    let mut d = DataObject::new();
    d.put_string("lib", &lib);
    RustCmd::new("yypums1847731c7fap5").execute(d).unwrap().get_string("a")
  }
}
impl dev_editcontrol {
  pub fn appdata(&self, data:DataObject) -> DataObject {
    let mut d = DataObject::new();
    d.put_object("data", data);
    RustCmd::new("vsxqui18332a86185i159").execute(d).unwrap().get_object("a")
  }
  pub fn publishapp(&self, data:DataObject) -> DataArray {
    let mut d = DataObject::new();
    d.put_object("data", data);
    RustCmd::new("iwvgmq1835bb194ffo8").execute(d).unwrap().get_array("a")
  }
}
impl dev_github {
  pub fn import(&self, url:String) -> String {
    ...
    RustCmd::new("nnjgwh189dcdca95fq7c").execute(d).unwrap().get_string("a")
  }
  pub fn list(&self) -> DataObject {
    let mut d = DataObject::new();
    RustCmd::new("lovuhn189dc981ebch2f").execute(d).unwrap().get_object("a")
  }
}
impl peer_peer {
  pub fn discovery(&self) -> DataObject {
    let mut d = DataObject::new();
    RustCmd::new("mlrhvx183e6eabd19xb4").execute(d).unwrap().get_object("a")
  }
  pub fn info(&self, nn_sessionid:String, uuid:Data, salt:Data) -> DataObject {
    ...
    RustCmd::new("tkwkml18390d46728m8").execute(d).unwrap().get_object("a")
  }
  pub fn local(&self, request:DataObject, nn_session:DataObject, nn_sessionid:String) -> DataObject {
    ...
    d.put_object("nn_session", nn_session);
    d.put_string("nn_sessionid", &nn_sessionid);
    RustCmd::new("nylhvq183f6b61e43oc2").execute(d).unwrap().get_object("a")
  }
  pub fn peers(&self) -> DataArray {
    let mut d = DataObject::new();
    RustCmd::new("ywokvt1838c110d92l8").execute(d).unwrap().get_array("a")
  }
  pub fn remote(&self, nn_path:String, nn_params:DataObject, nn_headers:DataObject) -> DataBytes {
    ...
    RustCmd::new("txnvil183f6ffdf58w1d").execute(d).unwrap().get_bytes("a")
  }
}
impl peer_reboot {
  pub fn init(&self) -> DataObject {
    let mut d = DataObject::new();
    RustCmd::new("hygrki1842eac55a9w2a").execute(d).unwrap().get_object("a")
  }
  pub fn reboot(&self) -> DataObject {
    let mut d = DataObject::new();
    RustCmd::new("jmhvzv1843439faa0i305").execute(d).unwrap().get_object("a")
  }
}
impl peer_service {
  pub fn close_stream(&self, uuid:String, streamid:i64, write:bool) -> DataObject {
    ...
    RustCmd::new("zqxtsm18d3d4ef2b3j101").execute(d).unwrap().get_object("a")
  }
  pub fn discovery(&self) -> String {
    let mut d = DataObject::new();
    RustCmd::new("vtxmqr183e5ff3ef5u82").execute(d).unwrap().get_string("a")
  }
  pub fn exec(&self, uuid:String, app:String, cmd:String, params:DataObject) -> DataObject {
    ...
    RustCmd::new("nmojwg18386b2f0d2n2").execute(d).unwrap().get_object("a")
  }
  pub fn get_stream(&self, uuid:String, stream_id:i64) -> DataBytes {
    let mut d = DataObject::new();
    d.put_string("uuid", &uuid);
    d.put_int("stream_id", stream_id);
    RustCmd::new("hlmugl188ab38379arb5").execute(d).unwrap().get_bytes("a")
  }
  pub fn init(&self) -> DataObject {
    let mut d = DataObject::new();
    RustCmd::new("grvupm18379e9a159n8").execute(d).unwrap().get_object("a")
  }
  pub fn listen(&self, ipaddr:String, port:i64) -> i64 {
    let mut d = DataObject::new();
    d.put_string("ipaddr", &ipaddr);
    d.put_int("port", port);
    RustCmd::new("irxuhn18379cef5bcp4").execute(d).unwrap().get_int("a")
  }
  pub fn listen_udp(&self, ipaddr:String, port:i64) -> i64 {
    let mut d = DataObject::new();
    d.put_string("ipaddr", &ipaddr);
    d.put_int("port", port);
    RustCmd::new("rgxowg183ad6b7a12u6").execute(d).unwrap().get_int("a")
  }
  pub fn maintenance(&self) -> String {
    let mut d = DataObject::new();
    RustCmd::new("rjntml18385b15b5ch0").execute(d).unwrap().get_string("a")
  }
  pub fn new_stream(&self, uuid:String) -> i64 {
    let mut d = DataObject::new();
    d.put_string("uuid", &uuid);
    RustCmd::new("myuvuz18d36f76d2cg3").execute(d).unwrap().get_int("a")
  }
  pub fn session_expire(&self, user:DataObject) -> DataObject {
    let mut d = DataObject::new();
    d.put_object("user", user);
    RustCmd::new("lvvzvn183bd066566j4").execute(d).unwrap().get_object("a")
  }
  pub fn stream_write(&self, uuid:String, stream_id:i64, data:DataBytes) -> bool {
    ...
    RustCmd::new("pmumpq18d39a2594cp3").execute(d).unwrap().get_boolean("a")
  }
  pub fn tcp_connect(&self, uuid:String, ipaddr:String, port:i64) -> bool {
    ...
    d.put_string("ipaddr", &ipaddr);
    d.put_int("port", port);
    RustCmd::new("ltnpiq18385ba6cc7u3").execute(d).unwrap().get_boolean("a")
  }
  pub fn udp_connect(&self, ipaddr:String, port:i64) -> DataObject {
    let mut d = DataObject::new();
    d.put_string("ipaddr", &ipaddr);
    d.put_int("port", port);
    RustCmd::new("gloivk183adf03115od").execute(d).unwrap().get_object("a")
  }
}

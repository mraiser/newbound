...
public class Mod extends Primitive 
{
	public Mod() throws JSONException {
		super("{ in: { a: {}, b: {} }, out: { c: {} } }");
	}
	...
	public JSONObject execute(JSONObject in) 
	{
		...
		try
		{
			...
			Object c = mod(a,b);
			if (c == null) throw new RuntimeException("Cannot mod types "+a.getClass().getName()+ " and "+b.getClass().getName());
			out.put("c", c);
		}

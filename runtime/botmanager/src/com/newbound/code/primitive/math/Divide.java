...
{
	public Divide() throws JSONException {
		super("{ in: { a: {}, b: {} }, out: { c: {} } }");
	}
	...
	public JSONObject execute(JSONObject in) 
	{
		...
		try {
			...
			Object c = divide(a, b);
			if (c == null)
				throw new RuntimeException("Cannot divide types " + a.getClass().getName() + " and " + b.getClass().getName());
			out.put("c", c);
		}
	...
	private Object divide(Number a, Number b) 
	{
